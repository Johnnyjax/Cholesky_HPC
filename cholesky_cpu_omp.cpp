...
// SPD Matrix Generation – unchanged
...
int main() {
    ...
    for (int num_threads : {1, 2, 4}) {
        ...
        string filename = "cholesky_cpu_timing_" + to_string(num_threads) + "threads.csv";
        ...
        for (int n : sizes) {
            ...
            cout << "[Threads=" << num_threads << "] N=" << n << ", Avg Time: " << avg_time << " us, Avg Cycles: " << avg_cycles << endl;
        }
